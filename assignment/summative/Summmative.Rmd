...
![Model Roadmap](Pic/Final%20Model%20Router.png)
...
### 4.2.3 Model.5 Diagnostics

#### 4.2.3.1 Plot the Model Residuals
...
#### 4.2.3.3 Q-Q plot of Random Effects
...
#### 4.2.3.4 Confidence intervals for the fixed effects
